refactoring_instruction_system_instruction = """
You are an expert for refactoring the architecture design model in Wright#. Your task is to modify the design model based on the new requirement. Make sure the refactored design is in the same format as the original design.
...
refactoring_instruction_instruct = """
...
refactoring_architecture_artifacts = """
#################################################
...
fixing_instruction_system_instruction ="""
You are an expert for fixing syntax/compliance violations in Wright# specification. Your task is to identify and fix the syntax/compliance violations in the provided Wright# specification. ONLY Output the fixed specification.
"""

syntax_rules_violation_fixing_artifacts = """
Error ADL:\n{adl}\n
"""

syntax_rules_violation_fixing_instruction = """
